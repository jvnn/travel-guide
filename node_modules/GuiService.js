function GuiService() {
  ...
  var removeMarkerCallback = null;

  function getSmallSummary(item, killMarker) {
    removeMarkerCallback = killMarker;
    ...
    html += '<div id="input-delete-small-summary" class="button input-delete" onClick="guiService.confirmDeletion(document);">'
    html += '<img src="../img/delete.svg" /></div>';
    html += '<div id="input-confirmation-small-summary" class="button input-confirmation" onClick="guiService.deleteItem()">'
    html += 'Sure..?</div>';
    html += '</div>';
    return html;
  }
